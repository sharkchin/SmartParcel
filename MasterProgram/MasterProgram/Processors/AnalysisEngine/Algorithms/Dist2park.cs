...
{
    class Dist2park : IGeometryAlgorithm
    {
        ...
        public object ProcessRecord(AbstractRecord record, bool isSubByTask)
        {
            ...
            facts.Add("NearestParkName", "NA");
            facts.Add("Dist2park", -9999);
            ...
            else
            {
                ...
                impactors = null;
                facts["Dist2park"]= dist * METER_PER_DEGREE;
                facts["NearestParkName"]=closeimp["NAME"];
